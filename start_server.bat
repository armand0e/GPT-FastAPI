...
wt new-tab -p "Command Prompt" cmd.exe /k "cloudflared tunnel run" ; split-pane -V -p "Command Prompt" cmd.exe /k "cd \Users\aranr\Documents\GitHub\GPT-FastAPI && python src\main.py"
